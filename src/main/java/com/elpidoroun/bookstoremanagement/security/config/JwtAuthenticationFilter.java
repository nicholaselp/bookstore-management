package com.elpidoroun.bookstoremanagement.security.config;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        if(request.getServletPath().contains(AUTH_URL) || (nonNull(request.getPathInfo()) && request.getPathInfo().contains(AUTH_URL))){
